...
},{"./adapters/http":3,"./adapters/xhr":3,"./helpers/normalizeHeaderName":24,"./utils":27,"_process":33}],18:[function(require,module,exports){
'use strict';
...
LocatorBuilders.add("xpath:neighbor", function(e) {
  return new NeighborLocatorsGenerator().getXpathsByNeighbors(e, false);
});

module.exports.LocatorBuilders = LocatorBuilders;

},{"./neighborLocatorsGenerator":31}],31:[function(require,module,exports){
var $ = require("jquery");
